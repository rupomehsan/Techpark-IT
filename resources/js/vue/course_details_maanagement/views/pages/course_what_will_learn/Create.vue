                        ...
                        <div class="col-xl-10 col-12">
                            <div class="row g-3">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" id="title" name="title" class="form-control" placeholder="basic programming" />
                                </div>
                            </div>
                        </div>
                    </div>
...
export default {
    ...
    methods: {
        store_batch: async function(event) {
            ...
            await axios.post('/api/v1/course/course-you-will-learn/store', data.formData).then((response) => {
