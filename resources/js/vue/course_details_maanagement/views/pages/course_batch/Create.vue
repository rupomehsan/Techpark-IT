                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="batch_student_limit" name="batch_student_limit"
                                            class="form-control" placeholder="eg: 40,50" />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="form-label" for="seat_booked">Batch Seat booked</label>
                                        <input type="number" name="seat_booked" id="seat_booked" class="form-control"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="booked_percent" id="booked_percent" class="form-control"
                                            placeholder="eg: 40,50" />
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="course_discount" id="course_discount"
                                            class="form-control" placeholder="eg: 30,20" />
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="after_discount_price" id="after_discount_price"
                                            class="form-control" placeholder="eg: 9500,8200" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="admission_start_date" id="admission_start_date"
                                            class="form-control" />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="admission_end_date" id="admission_end_date"
                                            class="form-control" />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="first_class_date" id="first_class_date"
                                            class="form-control" />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="class_days" name="class_days" class="form-control"
