<template>
  ...
  <div id="sidebar-wrapper">
    ...
    <ul class="metismenu" id="menu">
      ...
      <side-bar-single-menu :icon="`zmdi zmdi-view-dashboard`" :menu_title="`Dashboard`" :route_name="`adminDashboard`" />
      <!-- Management start -->
      ...
      <side-bar-drop-down-menus
        :icon="`fa fa-plus`"
        :menu_title="`VocabularyManagement`"
        :menus="[
          {
            route_name: `AllVocabulary`,
            title: `Vocabulary`,
            icon: `zmdi zmdi-dot-circle-alt`,
          },

          // {
          //   route_name: `AllVocabolaryStoryGroup`,
          //   title: `VocabolaryStoryGroup`,
          //   icon: `zmdi zmdi-dot-circle-alt`,
          // },
          {
            route_name: `AllVocabolaryStory`,
            title: `VocabolaryStory`,
            icon: `zmdi zmdi-dot-circle-alt`,
          },
      ...
      <side-bar-drop-down-menus
        :icon="`fa fa-plus`"
        :menu_title="`SentenceManagement`"
        :menus="[
          {
            route_name: `AllSentenceGroup`,
            title: `SentenceGroup`,
            icon: `zmdi zmdi-dot-circle-alt`,
          },
          {
            route_name: `AllSentence`,
            title: `Sentence`,
            icon: `zmdi zmdi-dot-circle-alt`,
          },
          {
            route_name: `AllSentenceRule`,
            title: `SentenceRule`,
            icon: `zmdi zmdi-dot-circle-alt`,
          },
        ]"
