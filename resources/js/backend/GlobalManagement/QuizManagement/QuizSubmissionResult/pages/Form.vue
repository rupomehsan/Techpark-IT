    ...
    <form @submit.prevent="submitHandler">
      <div class="card">
        ...
        <div class="card-body card_body_fixed_height">
          <div class="row">
            <quiz-drop-down-el :name="'quiz_id'" :multiple="false" :value="item.quiz_id" />
            <course-module-class-drop-down-el :name="'course_module_class_id'" :multiple="false" :value="item.course_module_class_id" />
