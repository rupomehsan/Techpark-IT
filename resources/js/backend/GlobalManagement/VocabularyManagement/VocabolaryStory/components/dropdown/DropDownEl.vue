...
export default {
  ...
  methods: {
    ...
    reset: function () {
      // Clear selection and close the dropdown
      this.selected = [];
      this.show_list = false;
      // Clear search box if using writable search_key
      if (typeof this.search_key !== 'undefined') {
        this.search_key = '';
      }
      // Emit updates for v-model or parent listeners
