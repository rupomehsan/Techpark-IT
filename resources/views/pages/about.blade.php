        ...
        <div class="row g-3" bis_skin_checked="1">
          <div class="col-md-6" bis_skin_checked="1">
            ...
            >
              <p>
                ...
                and never compromise with their service quality.
              </p>
              <p>
                Specialized in manufacturing customized &amp; ready-made
                software solutions, mobile apps, website development, and theme
          ...
          <div class="col-md-6" bis_skin_checked="1">
            ...
            >
              ...
              <p>
                Boldly, climbing the growth graph in the software industry. Our
                core strength is our skilled software developer, support
                engineer, and digital marketing team and deploys meaningful
                digital &amp; next-generation tech solutions to every customer.
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="row g-3" bis_skin_checked="1">
          <div class="col-xl-2 col-md-4 col-sm-6" bis_skin_checked="1">
            ...
            >
              ...
              <div
                class="fs-2 fw-bold lh-1 mb-2 mt-3 text-black"
                bis_skin_checked="1"
              >
                <span>50</span>+
              </div>
              <div bis_skin_checked="1">Projects</div>
            </div>
          </div>
          <div class="col-xl-2 col-md-4 col-sm-6" bis_skin_checked="1">
            <div
            ...
            >
              ...
              <div bis_skin_checked="1">Products</div>
            </div>
          </div>
          <div class="col-xl-2 col-md-4 col-sm-6" bis_skin_checked="1">
            <div
            ...
            >
              ...
              <div bis_skin_checked="1">Experts</div>
            </div>
          </div>
          <div class="col-xl-2 col-md-4 col-sm-6" bis_skin_checked="1">
            <div
            ...
            >
              ...
              <div bis_skin_checked="1">Countries</div>
            </div>
          </div>
          <div class="col-xl-2 col-md-4 col-sm-6" bis_skin_checked="1">
            <div
            ...
            >
              ...
              <div bis_skin_checked="1">Happy Clients</div>
            </div>
          </div>
          <div class="col-xl-2 col-md-4 col-sm-6" bis_skin_checked="1">
            <div
            ...
            >
              ...
              <div bis_skin_checked="1">Years Experienced</div>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row g-3 justify-content-center" bis_skin_checked="1">
          <div class="col-xl-4 col-sm-6" bis_skin_checked="1">
            ...
            >
              ...
              <p class="mb-0">
                We believe in being genuine, hence it gets easy for us to
          ...
          <div class="col-xl-4 col-sm-6" bis_skin_checked="1">
            ...
            >
              ...
              <p class="mb-0">
                Exclusively dedicated to our work and devoted to fulfilling our
                client commitment.
              </p>
            </div>
          </div>
          <div class="col-xl-4 col-sm-6" bis_skin_checked="1">
            <div
              ...
              style="visibility: hidden; animation-name: none"
            >
              <h4 class="mb-3">Outspoken</h4>
              <p class="mb-0">
                Dedicatedly work hard &amp; present the perfect solution to
                every problem.
              </p>
            </div>
          </div>
          <div class="col-xl-4 col-sm-6" bis_skin_checked="1">
            <div
              ...
              style="visibility: hidden; animation-name: none"
            >
              <h4 class="mb-3">Self Improvement</h4>
              <p class="mb-0">
                We arrange both on/off the job training for our employees. New
                ideas can take us to new successes.
              </p>
            </div>
          </div>
          <div class="col-xl-4 col-sm-6" bis_skin_checked="1">
            ...
            >
              ...
              <p class="mb-0">Working together and unity is our strength.</p>
            </div>
          </div>
        </div>
      </div>
