            ...
            <div class="course_progress_mearn">
                ...
                <div class="course_progress_area">
                    <div class="course_progress">
                        <div class="course_progress_title">কোর্স প্রোগ্রেস
                            {{ \App\Helpers\ConvertHelper::convertToBanglaNumbers($progress) }} %</div>
                                                        ...
                                                        <div class="class_module_title_details">
                                                            ...
                                                            <ul class="details">
                                                                ...
                                                                <li>
                                                                    ...
                                                                    {{ \App\Helpers\ConvertHelper::convertToBanglaNumbers($item->classes->where('type', 'recorded')->count()) }}
                                                                    টি রেকর্ডেড ক্লাস
                                                                </li>
                                                                ।
                                                                <li>
                                                        ...
                                                        @foreach ($item->classes as $key => $class)
                                                            <li>
                                                                ...
                                                                <div data-key="{{ $key }}"
                                                                    ...
                                                                    onclick="getClassVideolink(`{{ $class->class_video_link }}`); courseCompletion('{{ $course->id }}', {{ $course_mile_stone->id }}, {{ $item->id }}, {{ $class->id }})">
                                                                    @if ($class->is_complete)
                                                                        <div class="live_class_icon">
                                                                            <i
                                                                                class="fa-solid fa-circle-check text-success"></i>
                                                                ...
                                                                @if ($class->class_quiz && $class->class_quiz->quiz)
                                                                    <div class="quiz_and_mcq">
                                                                        ...
                                                                        <a href="{{ route('quiz.show', $class->class_quiz->quiz->slug) }}"
                                            ...
                                            <tbody>
                                                @foreach ($routine as $class_routine)
                                                    <tr>
                                                        ...
                                                        <td>{{ $class_routine->date->format('d F') }} -
                                                            {{ $class_routine->date->format('l') }}</td>
                                                        <td>রাত
