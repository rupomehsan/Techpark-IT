<div class="glance bg_grad2 py_100 position-relative bg_banner_area_left">
    <div class="why-choose-one__shape-3 float-bob-y" style=" top: 100px;
            left: 60%; z-index: 0;">
    ...
    <div class="container-md">
        <div class="row justify-content-center">
            <div class="col-xl-6 col-md-10 col-lg-8">
                <div class="text-center mb-5">
                    <h2 class="fs-1 fw-bold text-bdtask animate-text">At a Glance</h2>
                    <div class="student_success_history_area_sub_title">
                        <span class="sub_title">
                            At a glance, explore our achievements and milestones that showcase our dedication and
                            <br> success in various fields.
                        </span>
                    </div>
                </div>
            </div>
        ...
        <div class="row g-3">
            ...
            <div class="col-xl-4 col-md-6 col-sm-6 my-5">
                <div
                    class="d-block py-4 shadow-sm text-center wow fadeInUp translateOnHover at_a_glance_card animated-box in ">
                    <div class="mh_45">
                        <svg id="Group_334" data-name="Group 334" xmlns="http://www.w3.org/2000/svg" width="41.375"
                            height="41.38" viewBox="0 0 41.375 41.38">
                            <path id="Path_472" data-name="Path 472"
                                ...
                                transform="translate(2134.485 -691.695)" fill="#fff"></path>
                            <path id="Path_473" data-name="Path 473"
                                ...
                                transform="translate(1932.157 -981.764)" fill="#fff"></path>
                            <path id="Path_474" data-name="Path 474"
                                ...
                                transform="translate(2072.14 -1226.546)" fill="#fff"></path>
                            <path id="Path_475" data-name="Path 475"
                                ...
                                transform="translate(2072.136 -1019.669)" fill="#fff"></path>
                            <path id="Path_476" data-name="Path 476"
                                ...
                                transform="translate(2072.108 -1122.375)" fill="#fff"></path>
                        </svg>
                    </div>
                    <div class="fs-2 fw-bold lh-1 mb-2 mt-3 text-white"><span class="counter" data-count="50"
                            ended="true">50</span>+</div>
                    <div>Projects</div>
                </div>
            </div>
            <div class="col-xl-4 col-md-6 col-sm-6 my-5">
                <div class="d-block py-4 shadow-sm text-center wow fadeInUp translateOnHover at_a_glance_card animated-box in"
                    data-wow-delay="0.2s">
                    <div class="mh_45">
                        <svg xmlns="http://www.w3.org/2000/svg" width="39.24" height="44.889"
                            ...
                            <g id="_2Jgj3q" data-name="2Jgj3q" transform="translate(3147.395 -519.695)">
                                <g id="Group_335" data-name="Group 335" transform="translate(-3147.395 519.695)">
                                    <path id="Path_477" data-name="Path 477"
                                        ...
                                        transform="translate(3147.395 -519.695)" fill="#fff"></path>
                                </g>
                            </g>
                        </svg>
                    </div>
                    <div class="fs-2 fw-bold lh-1 mb-2 mt-3 text-white">
                        <span class="counter" data-count="40" ended="true">40</span>+
                    </div>
                    <div>Products</div>
                </div>
            </div>
            <div class="col-xl-4 col-md-6 col-sm-6 my-5 ">
                <div class="d-block py-4 shadow-sm text-center wow fadeInUp translateOnHover at_a_glance_card animated-box in"
                    ...
                    <div class="mh_45">
                        <svg xmlns="http://www.w3.org/2000/svg" width="34.37" height="40.247"
                            viewBox="0 0 34.37 40.247">
                            <g id="zvwJUH" transform="translate(1075.783 366.593)">
                                <g id="Group_336" data-name="Group 336" transform="translate(-1075.783 -366.593)">
                                    <path id="Path_478" data-name="Path 478"
                                        ...
                                        transform="translate(1075.783 366.593)" fill="#fff"></path>
                                </g>
                            </g>
                        </svg>
                    </div>
                    <div class="fs-2 fw-bold lh-1 mb-2 mt-3 text-white"><span class="counter" data-count="100"
                            ended="true">100</span>+</div>
                    <div>Experts</div>
                </div>
            </div>
            <div class="col-xl-4 col-md-6 col-sm-6 my-5 ">
                    ...
                    <div class="mh_45">
                        <svg xmlns="http://www.w3.org/2000/svg" width="33.692" height="43.896"
                            ...
                            <g id="_2MLMWq" data-name="2MLMWq" transform="translate(1332.433 328.542)">
                                <g id="Group_338" data-name="Group 338" transform="translate(-1332.433 -328.542)">
                                    <path id="Path_479" data-name="Path 479"
                                        ...
                                        transform="translate(1332.433 328.542)" fill="#fff"></path>
                                </g>
                            </g>
                        </svg>
                    </div>
                    ...
                    <div class="mh_45">
                        <svg xmlns="http://www.w3.org/2000/svg" width="47.353" height="44.297"
                            ...
                            <path id="Path_60" data-name="Path 60"
                                ...
                                transform="translate(-0.927 -2.995)" fill="#fff"></path>
                        </svg>
                    </div>
                    <div class="fs-2 fw-bold lh-1 mb-2 mt-3 text-white"><span class="counter" data-count="10"
                            ended="true">10</span>K+</div>
                    ...
                    <div class="mh_45">
                        <svg xmlns="http://www.w3.org/2000/svg" width="62.842" height="43.148"
                            ...
                            <g id="lBKXOS" transform="translate(1582.994 262.826)">
                                <g id="Group_339" data-name="Group 339" transform="translate(-1582.994 -262.826)">
                                    <path id="Path_480" data-name="Path 480"
                                        ...
                                        transform="translate(1544.107 219.924)" fill="#fff"></path>
                                    <path id="Path_481" data-name="Path 481"
                                        ...
                                        transform="translate(1566.342 212.492)" fill="#fff"></path>
                                    <path id="Path_482" data-name="Path 482"
                                        ...
                                        transform="translate(1539.092 262.826)" fill="#fff"></path>
                                    <path id="Path_483" data-name="Path 483"
                                        ...
                                        transform="translate(1511.138 212.386)" fill="#fff"></path>
                                    <path id="Path_484" data-name="Path 484"
                                        ...
                                        transform="translate(1567.003 255.91)" fill="#fff"></path>
                                    <path id="Path_485" data-name="Path 485"
                                        ...
                                        transform="translate(1506.214 255.932)" fill="#fff"></path>
                                    <path id="Path_486" data-name="Path 486"
                                        ...
                                        transform="translate(1582.994 206.564)" fill="#fff"></path>
                                    <path id="Path_487" data-name="Path 487"
                                        ...
                                        transform="translate(1487.429 206.19)" fill="#fff"></path>
                                    <path id="Path_488" data-name="Path 488"
                                        ...
                                        transform="translate(1483.835 234.832)" fill="#fff"></path>
                                    <path id="Path_489" data-name="Path 489"
                                        ...
                                        transform="translate(1581.933 234.818)" fill="#fff"></path>
                                    <path id="Path_490" data-name="Path 490"
                                        ...
                                        transform="translate(1549.706 235.522)" fill="#fff"></path>
                                    <path id="Path_491" data-name="Path 491"
                                        ...
                                        transform="translate(1514.595 235.525)" fill="#fff"></path>
                                </g>
                            </g>
                        </svg>
                    </div>
                    <div class="fs-2 fw-bold lh-1 mb-2 mt-3 text-white">
                        <span class="counter" data-count="10" ended="true">10</span>+
                    </div>
...
<script>
    ...
    function countUp(elem) {
        const target = +elem.getAttribute('data-count');
        let count = 0;
        ...
        function updateCount() {
            count += increment;
            if (count < target) {
                elem.textContent = Math.floor(count);
    ...
    // ✅ Main function to trigger count-up when in view
    function handleScroll() {
        const counters = document.querySelectorAll('.counter');

        counters.forEach(counter => {
            if (!counter.classList.contains('counted') && isInViewport(counter)) {
                counter.classList.add('counted'); // mark as done
                countUp(counter);
            }
        });
    }
...
@push('styles')
    <style>
        ...
        .animated-box:after {
            ...
            bottom: 0;
            border-radius: 5px;
            background: linear-gradient(120deg, #ffc107, #dc35459c, #dc262633);
        ...
        .mh_45 {
            ...
            /* Make sure it's inline or block-level */
