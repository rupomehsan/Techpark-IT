...
class GetAllData
{
    ...
    $q->where('host', 'like', '%' . $searchKey . '%');    

    $q->orWhere('port', 'like', '%' . $searchKey . '%');    

    $q->orWhere('email', 'like', '%' . $searchKey . '%');    

    $q->orWhere('username', 'like', '%' . $searchKey . '%');    

    $q->orWhere('password', 'like', '%' . $searchKey . '%');    

    $q->orWhere('mail_from_name', 'like', '%' . $searchKey . '%');    

    $q->orWhere('mail_from_email', 'like', '%' . $searchKey . '%');    

    $q->orWhere('encryption', 'like', '%' . $searchKey . '%');              
