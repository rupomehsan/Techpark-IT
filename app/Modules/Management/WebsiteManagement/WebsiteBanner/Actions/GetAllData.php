...
class GetAllData
{
    ...
    $q->orWhere('subtitle', 'like', '%' . $searchKey . '%');    

    $q->orWhere('is_featured', 'like', '%' . $searchKey . '%');    

    $q->orWhere('image', 'like', '%' . $searchKey . '%');    

    $q->orWhere('btn_one_text', 'like', '%' . $searchKey . '%');    

    $q->orWhere('btn_one_url', 'like', '%' . $searchKey . '%');    

    $q->orWhere('btn_two_text', 'like', '%' . $searchKey . '%');    

    $q->orWhere('btn_two_url', 'like', '%' . $searchKey . '%');              
