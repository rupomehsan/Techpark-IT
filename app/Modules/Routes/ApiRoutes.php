...
include_once base_path("app/Modules/Management/VocabularyManagement/Vocabulary/Routes/Route.php");
include_once base_path("app/Modules/Management/VocabularyManagement/VocabularySentence/Routes/Route.php");
include_once base_path("app/Modules/Management/QuizManagement/QuizQuestionTopic/Routes/Route.php");
include_once base_path("app/Modules/Management/QuizManagement/QuizQuestion/Routes/Route.php");
include_once base_path("app/Modules/Management/QuizManagement/Quiz/Routes/Route.php");
include_once base_path("app/Modules/Management/QuizManagement/QuizSubmissionResult/Routes/Route.php");
...
include_once base_path("app/Modules/Management/GalleryManagement/GalleryCategory/Routes/Route.php");
include_once base_path("app/Modules/Management/GalleryManagement/Gallery/Routes/Route.php");
include_once base_path("app/Modules/Management/VocabularyManagement/VocabolaryStoryGroup/Routes/Route.php");
include_once base_path("app/Modules/Management/VocabularyManagement/VocabolaryStory/Routes/Route.php");
include_once base_path("app/Modules/Management/SentenceManagement/SentenceGroup/Routes/Route.php");
include_once base_path("app/Modules/Management/SentenceManagement/Sentence/Routes/Route.php");
include_once base_path("app/Modules/Management/SentenceManagement/SentenceRule/Routes/Route.php");
